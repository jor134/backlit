// BACKLIT family song server: Cloudflare Pages Function at /api/family
// Cloudflare settings for this Pages project:
//   Bindings:  R2 bucket  -> variable name SONGS     (where the song .zip files live)
//              D1 database -> variable name DB       (optional here: limits sign-in attempts; the leaderboard needs it anyway)
//   Variables and secrets:  FAMILY_PASSWORD, SESSION_SECRET (32+ random characters), optional SONGS_PREFIX (a folder in the bucket)
const DAYS = 30;
