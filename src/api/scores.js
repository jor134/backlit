// BACKLIT leaderboards: handles /api/scores (called from src/index.js), stored in D1.
// Binding, set in wrangler.jsonc: DB = D1 database. Tables are created automatically on first use.
